...
Client for calendar_service to interact with account_service.
Used for validating user existence for calendar operations.
"""
...
class AccountClient:
    """
    Wrapper client for Account Service calls from Calendar Service.

    This wrapper provides calendar-specific convenience methods
    ...
    # =============================================================================
    # Calendar-specific convenience methods
    # =============================================================================
    ...
    async def validate_user_exists(self, user_id: str) -> bool:
        ...
        Used before calendar event creation.
    ...
    async def get_user_info(self, user_id: str) -> Optional[dict]:
        """
        Get user information for calendar context.
    ...
    async def check_user_active(self, user_id: str) -> bool:
        ...
        Prevents calendar operations for suspended/deleted accounts.
    ...
    async def get_user_timezone(self, user_id: str) -> str:
        """
        Get user's preferred timezone for calendar events.
    ...
    async def get_user_calendar_preferences(self, user_id: str) -> dict:
        """
        ...
        Returns:
            Dict with calendar preferences
        """
        try:
            profile = await self._client.get_account_profile(user_id)
            if profile:
                ...
                return {
                    ...
                    "week_start": preferences.get("week_start", "sunday"),
                    "time_format": preferences.get("time_format", "12h"),
                    "default_reminder_minutes": preferences.get("default_reminder", 15)
                }
            return {
                "timezone": "UTC",
                "week_start": "sunday",
