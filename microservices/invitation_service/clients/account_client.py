...
Client for invitation_service to interact with account_service.
Used for validating user existence and getting user info for invitations.
"""
...
class AccountClient:
    """
    Wrapper client for Account Service calls from Invitation Service.
    ...
    async def validate_user_exists(self, user_id: str) -> bool:
        ...
        Used before sending invitations.
    ...
    async def get_user_by_email(self, email: str) -> Optional[dict]:
        ...
        Used to check if invitee already has an account.

        Args:
            email: Email address

        Returns:
            User account profile or None if not found
        """
        try:
    ...
    async def get_user_info(self, user_id: str) -> Optional[dict]:
        """
        Get user information for invitation context.
    ...
    async def get_user_email(self, user_id: str) -> Optional[str]:
        """
        Get user email for sending invitation notifications.
    ...
    async def get_user_name(self, user_id: str) -> Optional[str]:
        """
        Get user name for invitation display.
    ...
    async def check_user_active(self, user_id: str) -> bool:
        ...
        Prevents invitations from/to suspended/deleted accounts.
