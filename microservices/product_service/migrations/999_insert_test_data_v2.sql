...
VALUES
    ...
    ('prod_ai_tokens', 'AI Tokens', 'AI-TOKENS', 'AI model tokens for testing', 'ai_models', 'model_inference', 0.02, 'USD', 'monthly',
     '["token_usage", "api_access"]'::jsonb,
     '{"max_tokens": 100000}'::jsonb,
     true,
     '{"provider": "test", "model": "test-model", "context_window": 4096}'::jsonb,
     NOW(), NOW()),
    ...
    ('claude-3-5-sonnet', 'Claude 3.5 Sonnet', 'CLAUDE35-SONNET', 'Anthropic Claude 3.5 Sonnet model', 'ai_models', 'model_inference', 0.003, 'USD', 'per_token',
     '["advanced_reasoning", "coding", "analysis"]'::jsonb,
     '{"max_tokens": 200000}'::jsonb,
     true,
     '{"provider": "anthropic", "model": "claude-3-5-sonnet-20241022", "context_window": 200000, "input_cost_per_1k": 0.003, "output_cost_per_1k": 0.015}'::jsonb,
     NOW(), NOW())
...
-- AI Tokens Pricing: $0.02 per 1000 tokens (which is $0.00002 per token)
INSERT INTO product.product_pricing (pricing_id, product_id, tier_name, min_quantity, max_quantity, unit_price, currency, metadata, created_at, updated_at)
VALUES
    ('pricing_ai_tokens_base', 'prod_ai_tokens', 'base', 0, NULL, 0.00002, 'USD',
     '{"unit": "token", "cost_per_1k_tokens": 0.02, "billing_type": "usage_based"}'::jsonb,
     NOW(), NOW())
ON CONFLICT (pricing_id) DO UPDATE SET
    unit_price = EXCLUDED.unit_price,
    updated_at = NOW();

-- GPT-4o-mini Pricing: $0.00015 per 1K input tokens, $0.0006 per 1K output tokens (average ~$0.0003 per token)
INSERT INTO product.product_pricing (pricing_id, product_id, tier_name, min_quantity, max_quantity, unit_price, currency, metadata, created_at, updated_at)
VALUES
    ('pricing_gpt4o_mini_base', 'gpt-4o-mini', 'base', 0, NULL, 0.0000003, 'USD',
...
INSERT INTO product.product_pricing (pricing_id, product_id, tier_name, min_quantity, max_quantity, unit_price, currency, metadata, created_at, updated_at)
VALUES
    ('pricing_gpt4o_base', 'gpt-4o', 'base', 0, NULL, 0.000005, 'USD',
...
-- Claude 3.5 Sonnet Pricing: $0.003 per 1K input tokens, $0.015 per 1K output tokens
INSERT INTO product.product_pricing (pricing_id, product_id, tier_name, min_quantity, max_quantity, unit_price, currency, metadata, created_at, updated_at)
VALUES
    ('pricing_claude35_sonnet_base', 'claude-3-5-sonnet', 'base', 0, NULL, 0.000009, 'USD',
