...
async def lookup_cost_definition(
    ...
    gpu_count: Optional[int] = Query(None, description="GPU count"),
    prefill_seconds: Optional[float] = Query(None, description="Prefill seconds"),
    generation_seconds: Optional[float] = Query(None, description="Generation seconds"),
    queue_seconds: Optional[float] = Query(None, description="Queue seconds"),
