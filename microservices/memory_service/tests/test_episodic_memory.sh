...
# Test 2: Extract Episodic Memory from Dialog
print_section "Test 2: Extract Episodic Memory from Dialog (AI-Powered)"
...
# Test 3: Get Episodic Memory by ID
if [ -n "$MEMORY_ID" ] && [ "$MEMORY_ID" != "null" ]; then
    print_section "Test 3: Get Episodic Memory by ID"
...
# Test 4: Search Episodes by Event Type
print_section "Test 4: Search Episodes by Event Type"
...
# Test 5: List All Episodic Memories
print_section "Test 5: List All Episodic Memories for User"
...
# Test 6: Extract Complex Episode
print_section "Test 6: Extract Complex Episode with Multiple Elements"
echo "POST ${API_BASE}/episodic/extract"
COMPLEX_PAYLOAD='{
  "user_id": "test_user_456",
...
# Test 7: Update Episodic Memory
if [ -n "$MEMORY_ID" ] && [ "$MEMORY_ID" != "null" ]; then
    print_section "Test 7: Update Episodic Memory"
...
# Test 8: Delete Episodic Memory
if [ -n "$MEMORY_ID" ] && [ "$MEMORY_ID" != "null" ]; then
    print_section "Test 8: Delete Episodic Memory"
