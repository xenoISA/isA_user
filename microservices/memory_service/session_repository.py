...
class SessionMemoryRepository(BaseMemoryRepository):
    ...
    def __init__(self, config: Optional[ConfigManager] = None):
        ...
        super().__init__(schema="memory", table_name="session_memories", config=config)
    ...
    async def store_session_summary(
        ...
        try:
            ...
            # Fallback: return the data we tried to insert
            return data
    ...
    async def get_by_ids(
        ...
        """
        Get session memories by their IDs
        ...
        try:
            ...
            logger.error(f"Error getting session memories by IDs: {e}")
            return []
