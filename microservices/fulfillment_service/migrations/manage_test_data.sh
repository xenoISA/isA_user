...
# Test Data Management Script for Fulfillment Service
...
case "$1" in
    seed)
        print_info "Seeding test data for Fulfillment Service..."
        execute_sql "$SCRIPT_DIR/seed_test_data.sql"
        ;;
    cleanup)
        print_info "Cleaning test data for Fulfillment Service..."
