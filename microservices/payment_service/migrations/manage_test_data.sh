...
# Test Data Management Script for Payment Service
# Usage: ./manage_test_data.sh [seed|cleanup]

set -e

# Configuration
POSTGRES_CONTAINER="${POSTGRES_CONTAINER:-isa-postgres-primary}"
POSTGRES_USER="${POSTGRES_USER:-postgres}"
POSTGRES_DB="${POSTGRES_DB:-isa_user_db}"
...
seed_data() {
    print_info "Seeding test data for Payment Service..."
...
cleanup_data() {
    print_info "Cleaning up test data for Payment Service..."
...
case "$1" in
    ...
    *)
        ...
        echo "  POSTGRES_CONTAINER - PostgreSQL container name (default: isa-postgres-primary)"
        echo "  POSTGRES_USER      - PostgreSQL user (default: postgres)"
        echo "  POSTGRES_DB        - PostgreSQL database (default: isa_user_db)"
        exit 1
        ;;
esac
