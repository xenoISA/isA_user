...
PROJECT_SERVICE_ROUTES = [
    ...
    {
        "path": "/api/v1/projects/health",
        "methods": ["GET"],
        "auth_required": False,
        "description": "Health check (prefixed)",
    },
    {
    ...
    {
        "path": "/api/v1/projects/{project_id}/instructions",
        "methods": ["PUT"],
        "auth_required": True,
    ...
    },
    {
        ...
        "methods": ["POST"],
        "auth_required": True,
        "description": "Upload project knowledge file",
    },
    {
        "path": "/api/v1/projects/{project_id}/files/{file_id}",
        "methods": ["DELETE"],
        "auth_required": True,
        "description": "Delete project knowledge file",
    },
]
