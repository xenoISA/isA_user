...
health = HealthCheck(
    "organization_service", version="1.0.0", shutdown_manager=shutdown_manager
)
health.add_postgres(
    lambda: organization_microservice.organization_service.repository.db
    if organization_microservice.organization_service
    and hasattr(organization_microservice.organization_service, "repository")
    and organization_microservice.organization_service.repository
    else None
)
...
@app.get(
    "/api/v1/organization/organizations/{organization_id}",
...
async def update_org_rate_limits(
    ...
    saved = await service.repository.update_org_rate_limits(organization_id, payload)
    if saved is None:
        raise HTTPException(
            status_code=status.HTTP_404_NOT_FOUND,
            detail="Organization not found",
        )
    return RateLimitsEnvelope(rate_limits=RateLimits(**saved), source="configured")
...
@app.post(
    "/api/v1/organization/organizations/{organization_id}/members",
...
async def get_organization_members(
    ...
    try:
        return await service.get_organization_members(
            organization_id, user_id, limit, offset, role
        )
    except OrganizationNotFoundError as e:
        raise HTTPException(status_code=status.HTTP_404_NOT_FOUND, detail=str(e))
    except OrganizationAccessDeniedError as e:
...
@app.put(
    "/api/v1/organization/organizations/{organization_id}/members/{member_user_id}",
    response_model=OrganizationMemberResponse,
)
async def update_organization_member(
    ...
    try:
        return await service.update_organization_member(
            organization_id, member_user_id, request, user_id
        )
    except OrganizationNotFoundError as e:
        raise HTTPException(status_code=status.HTTP_404_NOT_FOUND, detail=str(e))
    except OrganizationAccessDeniedError as e:
...
async def remove_organization_member(
    ...
    """移除组织成员"""
    try:
        success = await service.remove_organization_member(
            organization_id, member_user_id, user_id
        )
        if success:
...
@app.get(
    "/api/v1/organization/organizations/context",
...
@app.get(
    "/api/v1/organization/organizations/{organization_id}/stats",
...
@app.get(
    "/api/v1/organization/organizations/{organization_id}/usage",
...
@app.get(
    "/api/v1/organization/admin/organizations", response_model=OrganizationListResponse
)
...
@app.post(
    "/api/v1/organization/organizations/{organization_id}/sharing",
    response_model=SharingResourceResponse,
)
async def create_sharing(
    ...
    try:
        logger.info(
            f"[API] Creating sharing | organization_id={organization_id} | resource_type={request.resource_type} | created_by={user_id}"
        )
        ...
        logger.error(
            f"[API] Failed to create sharing | organization_id={organization_id} | error={e}"
        )
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR, detail=str(e)
        )
...
@app.get(
    "/api/v1/organization/organizations/{organization_id}/sharing/{sharing_id}",
...
async def get_sharing(
    ...
    try:
        ...
        logger.error(
            f"[API] Failed to get sharing | sharing_id={sharing_id} | error={e}"
        )
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR, detail=str(e)
        )
...
async def update_sharing(
    ...
    try:
        logger.info(
            f"[API] Updating sharing | sharing_id={sharing_id} | updated_by={user_id}"
        )
        ...
        logger.error(
            f"[API] Failed to update sharing | sharing_id={sharing_id} | error={e}"
        )
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR, detail=str(e)
        )
...
async def delete_sharing(
    ...
    try:
        logger.info(
            f"[API] Deleting sharing | sharing_id={sharing_id} | deleted_by={user_id}"
        )
        ...
        if success:
            ...
            raise HTTPException(
                status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
                detail="Failed to delete sharing",
            )
    except ValueError as e:
        raise HTTPException(status_code=status.HTTP_404_NOT_FOUND, detail=str(e))
    except Exception as e:
        logger.error(
            f"[API] Failed to delete sharing | sharing_id={sharing_id} | error={e}"
        )
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR, detail=str(e)
        )
...
async def list_organization_sharings(
    ...
    """获取组织所有共享资源列表"""
    try:
        return await service.list_organization_sharings(
            organization_id, user_id, resource_type, status_filter, limit, offset
        )
    except Exception as e:
        logger.error(
            f"[API] Failed to list sharings | organization_id={organization_id} | error={e}"
        )
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR, detail=str(e)
        )
...
@app.put(
    "/api/v1/organization/organizations/{organization_id}/sharing/{sharing_id}/members",
    response_model=MemberSharingPermissionResponse,
)
async def update_member_permission(
    ...
    try:
        logger.info(
            f"[API] Updating member permission | sharing_id={sharing_id} | member_user_id={request.user_id} | updated_by={user_id}"
        )
        ...
        logger.error(
            f"[API] Failed to update member permission | sharing_id={sharing_id} | error={e}"
        )
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR, detail=str(e)
        )
...
@app.delete(
    "/api/v1/organization/organizations/{organization_id}/sharing/{sharing_id}/members/{member_user_id}"
)
async def revoke_member_access(
    ...
    try:
        logger.info(
            f"[API] Revoking member access | sharing_id={sharing_id} | member_user_id={member_user_id} | revoked_by={user_id}"
        )
        success = await service.revoke_member_access(
            sharing_id, member_user_id, user_id
        )
        if success:
            ...
            raise HTTPException(
                status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
                detail="Failed to revoke member access",
            )
    except ValueError as e:
        raise HTTPException(status_code=status.HTTP_404_NOT_FOUND, detail=str(e))
    except Exception as e:
        logger.error(
            f"[API] Failed to revoke member access | sharing_id={sharing_id} | error={e}"
        )
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR, detail=str(e)
        )
...
@app.get(
    "/api/v1/organization/organizations/{organization_id}/members/{member_user_id}/shared-resources",
    response_model=MemberSharedResourcesResponse,
)
async def get_member_shared_resources(
    ...
    try:
        ...
        logger.error(
            f"[API] Failed to get member shared resources | member_user_id={member_user_id} | error={e}"
        )
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR, detail=str(e)
        )
...
@app.get(
    "/api/v1/organization/organizations/{organization_id}/sharing/{sharing_id}/usage",
    response_model=SharingUsageStatsResponse,
)
async def get_sharing_usage_stats(
    ...
    """获取共享资源使用统计"""
    try:
        return await service.get_sharing_usage_stats(
            sharing_id, user_id, period_start, period_end
        )
    except ValueError as e:
        raise HTTPException(status_code=status.HTTP_404_NOT_FOUND, detail=str(e))
    except Exception as e:
        logger.error(
            f"[API] Failed to get sharing usage stats | sharing_id={sharing_id} | error={e}"
        )
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR, detail=str(e)
        )
