...
Client for event_service to interact with account_service.
Used for validating user existence for event operations.
"""
...
class AccountClient:
    """
    Wrapper client for Account Service calls from Event Service.

    This wrapper provides event-specific convenience methods
    ...
    async def validate_user_exists(self, user_id: str) -> bool:
        ...
        Used before event creation and processing.
    ...
    async def get_user_info(self, user_id: str) -> Optional[dict]:
        """
        Get user information for event context.
    ...
    async def check_user_active(self, user_id: str) -> bool:
        ...
        Prevents event operations for suspended/deleted accounts.
