...
echo -e "  1. Creating telemetry data and alert rules for a test device"
echo -e "  2. Triggering device.deleted event from device_service"
echo -e "  3. Monitoring telemetry-service logs for event processing"
echo -e "  4. Verifying alert rules for the device were disabled"
echo ""
