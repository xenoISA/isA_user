...
SERVICE_ROUTES = [
    ...
    # Data ingestion
    {
        ...
        "methods": ["POST"],
        "auth_required": True,
        "description": "Ingest single data point",
    },
    {
        "path": "/api/v1/devices/{device_id}/telemetry/batch",
        "methods": ["POST"],
        "auth_required": True,
        "description": "Batch ingest data",
    },
    {
        "path": "/api/v1/telemetry/bulk",
        "methods": ["POST"],
        "auth_required": True,
        "description": "Bulk ingest multi-device",
    },
    # Metric management
    {
        "path": "/api/v1/metrics",
        "methods": ["GET", "POST"],
        "auth_required": True,
        "description": "List/create metrics",
    },
    {
        "path": "/api/v1/metrics/{metric_name}",
        "methods": ["GET", "DELETE"],
        "auth_required": True,
        "description": "Get/delete metric definition",
    },
    # Data queries
    {
        "path": "/api/v1/query",
    ...
    {
        "path": "/api/v1/devices/{device_id}/metrics/{metric_name}/latest",
        "methods": ["GET"],
        "auth_required": True,
        "description": "Get latest value",
    },
    {
        "path": "/api/v1/devices/{device_id}/metrics",
        "methods": ["GET"],
        "auth_required": True,
        "description": "Get device metrics",
    },
    {
        "path": "/api/v1/devices/{device_id}/metrics/{metric_name}/range",
        "methods": ["GET"],
        "auth_required": True,
        "description": "Get metric range",
    },
    # Aggregation
    {
        "path": "/api/v1/aggregated",
        "methods": ["GET"],
        "auth_required": True,
    ...
    # Alert management
    {
        ...
        "methods": ["GET", "POST"],
        "auth_required": True,
        "description": "List/create alert rules",
    },
    {
    ...
    {
        "path": "/api/v1/alerts/rules/{rule_id}/enable",
        "methods": ["PUT"],
        "auth_required": True,
    ...
    # Statistics
    {
        "path": "/api/v1/devices/{device_id}/stats",
        "methods": ["GET"],
        "auth_required": True,
    ...
    # Real-time streaming
    {
        ...
        "methods": ["POST", "DELETE"],
        "auth_required": True,
        "description": "Subscribe/unsubscribe real-time",
    },
    {
        "path": "/ws/telemetry/{subscription_id}",
        "methods": ["WS"],
        "auth_required": True,
