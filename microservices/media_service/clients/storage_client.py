"""
Storage Service Client for Media Service

HTTP client for synchronous communication with storage_service
Provides methods to fetch files and metadata
"""
...
class StorageServiceClient:
    ...
    def __init__(self, config_manager: Optional[ConfigManager] = None):
        ...
        """
        self.config_manager = config_manager or ConfigManager("media_service")
        ...
        self.client = httpx.AsyncClient(
            ...
            headers={
                ...
                "X-Service-Name": "media_service"  # Internal service identifier
            }
        )
    ...
    async def get_download_url(self, file_id: str) -> Optional[str]:
        ...
        try:
            ...
            return f"{self.base_url}/api/v1/files/download/{file_id}"
    ...
    async def download_file(self, file_id: str) -> Optional[bytes]:
        ...
        """
        try:
            response = await self.client.get(f"/api/v1/files/download/{file_id}")
