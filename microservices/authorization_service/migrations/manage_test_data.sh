...
# Authorization Service Test Data Management Script
...
case "$1" in
    seed)
        echo -e "${GREEN}=== Seeding Authorization Service Test Data ===${NC}"
        execute_sql "$SCRIPT_DIR/seed_test_data.sql"
        ;;
    cleanup)
        echo -e "${YELLOW}=== Cleaning Up Authorization Service Test Data ===${NC}"
